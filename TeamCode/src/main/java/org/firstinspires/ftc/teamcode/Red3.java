...
@Autonomous(name = "AUTORed3SingleMove (Blocks to Java)", preselectTeleOp = "DriveLauchTest")
public class AUTORed3SingleMove extends LinearOpMode {
     ...
     */
    private void RobotMoveAtSpeed(int ForwardVelocity, int CWRotationalVelocity, int RightVelocity, double MoveTime_sec) {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            RobotMoveAtSpeed(-30, 0, 0, 1.4);
            // align with the goal
            RobotMoveAtSpeed(-20, -23, 0, 2.1);
            // launch
            LaunchBalls(2, 3, 2500);
            // move the gate
            RobotMoveDistance(0, 45, 0, 5);
            // line up with the gate
            RobotMoveDistance(0, 0, -15, 5);
            // move toward the gate
            RobotMoveDistance(-20, 0, 0, 5);
        }
    }
}